...
namespace CompassEx.Data.Models {
	...
	public partial class View_Earth {
		...
		[JsonProperty]
		public virtual  int? EarthID { get; set; }

		[JsonProperty, Column(DbType = "VARCHAR(500)")]
		public virtual  string EarthName { get; set; }


	/// <summary>
	/// 一键转换为支持 WPF 双向绑定的 View_EarthVM 对象
	/// </summary>
	public virtual View_EarthVM ToViewModel() {
		return new View_EarthVM {
		...
		private static IFreeSql SafeOrm => Orm ?? throw new Exception($"{nameof(View_Earth)}.Orm 未在程序启动时初始化。");
		...
		/// </summary>
		public static ISelect<View_Earth> Select => SafeOrm.Select<View_Earth>();
		
		/// <summary>
		/// 🎯 PageList 静态方法：纯粹获取分好页的数据集合（不含任何 out 属性），pageIndex 小于等于 0 时自动查全部
		/// </summary>
		public static List<View_Earth> List(System.Linq.Expressions.Expression<Func<View_Earth, bool>> exp = null, int pageIndex = 0, int pageSize = 10, string sortField = null, bool isDesc = true)
		{
			var query = Select;
		...
		/// </summary>
		public static long GetRecordCount(System.Linq.Expressions.Expression<Func<View_Earth, bool>> exp = null)
		{
			var query = Select;
			if (exp != null) query = query.Where(exp);
		...
		/// </summary>
		public static View_Earth One(System.Linq.Expressions.Expression<Func<View_Earth, bool>> exp= null, string sortField = null, bool isDesc = true)
		{
    ...
    /// </summary>
    public partial class View_EarthVM : View_Earth, INotifyPropertyChanged {
		...
		public override int? EarthID {
			get => base.EarthID;
			set {
				if (System.Collections.Generic.EqualityComparer<int?>.Default.Equals(base.EarthID, value)) return;
				base.EarthID = value;
				OnPropertyChanged();
			}
		}

		public override string EarthName {
			get => base.EarthName;
			set {
				if (System.Collections.Generic.EqualityComparer<string>.Default.Equals(base.EarthName, value)) return;
				base.EarthName = value;
				OnPropertyChanged();
			}
		}
