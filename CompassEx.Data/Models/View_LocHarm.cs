...
namespace CompassEx.Data.Models {
	...
	public partial class View_LocHarm {
		...
		[JsonProperty]
		public virtual  int? LocHarmID { get; set; }

		[JsonProperty, Column(DbType = "VARCHAR(500)")]
		public virtual  string LocHarmName { get; set; }
	...
	/// <summary>
	/// 一键转换为支持 WPF 双向绑定的 View_LocHarmVM 对象
	/// </summary>
	public virtual View_LocHarmVM ToViewModel() {
		return new View_LocHarmVM {
			...
			LocHarmID = this.LocHarmID,
			LocHarmName = this.LocHarmName,
			Info = this.Info,
		};
	}
		...
		private static IFreeSql SafeOrm => Orm ?? throw new Exception($"{nameof(View_LocHarm)}.Orm 未在程序启动时初始化。");
		...
		/// </summary>
		public static ISelect<View_LocHarm> Select => SafeOrm.Select<View_LocHarm>();
		
		/// <summary>
		/// 🎯 PageList 静态方法：纯粹获取分好页的数据集合（不含任何 out 属性），pageIndex 小于等于 0 时自动查全部
		/// </summary>
		public static List<View_LocHarm> List(System.Linq.Expressions.Expression<Func<View_LocHarm, bool>> exp = null, int pageIndex = 0, int pageSize = 10, string sortField = null, bool isDesc = true)
		{
			var query = Select;
		...
		/// </summary>
		public static long GetRecordCount(System.Linq.Expressions.Expression<Func<View_LocHarm, bool>> exp = null)
		{
			var query = Select;
			if (exp != null) query = query.Where(exp);
		...
		/// </summary>
		public static View_LocHarm One(System.Linq.Expressions.Expression<Func<View_LocHarm, bool>> exp= null, string sortField = null, bool isDesc = true)
		{
    ...
    /// </summary>
    public partial class View_LocHarmVM : View_LocHarm, INotifyPropertyChanged {
		...
		public override int? LocHarmID {
			get => base.LocHarmID;
			set {
				if (System.Collections.Generic.EqualityComparer<int?>.Default.Equals(base.LocHarmID, value)) return;
				base.LocHarmID = value;
				OnPropertyChanged();
			}
		}

		public override string LocHarmName {
			get => base.LocHarmName;
			set {
				if (System.Collections.Generic.EqualityComparer<string>.Default.Equals(base.LocHarmName, value)) return;
				base.LocHarmName = value;
				OnPropertyChanged();
			}
		}
