...
namespace CompassEx.Data.Models {
	...
	public partial class View_LocTorture {
		...
		[JsonProperty]
		public virtual  int? LocTortureID { get; set; }

		[JsonProperty, Column(DbType = "VARCHAR(500)")]
		public virtual  string LocTortureName { get; set; }
	...
	/// <summary>
	/// 一键转换为支持 WPF 双向绑定的 View_LocTortureVM 对象
	/// </summary>
	public virtual View_LocTortureVM ToViewModel() {
		return new View_LocTortureVM {
			...
			LocTortureID = this.LocTortureID,
			LocTortureName = this.LocTortureName,
			Info = this.Info,
		};
	}
		...
		private static IFreeSql SafeOrm => Orm ?? throw new Exception($"{nameof(View_LocTorture)}.Orm 未在程序启动时初始化。");
		...
		/// </summary>
		public static ISelect<View_LocTorture> Select => SafeOrm.Select<View_LocTorture>();
		
		/// <summary>
		/// 🎯 PageList 静态方法：纯粹获取分好页的数据集合（不含任何 out 属性），pageIndex 小于等于 0 时自动查全部
		/// </summary>
		public static List<View_LocTorture> List(System.Linq.Expressions.Expression<Func<View_LocTorture, bool>> exp = null, int pageIndex = 0, int pageSize = 10, string sortField = null, bool isDesc = true)
		{
			var query = Select;
		...
		/// </summary>
		public static long GetRecordCount(System.Linq.Expressions.Expression<Func<View_LocTorture, bool>> exp = null)
		{
			var query = Select;
			if (exp != null) query = query.Where(exp);
		...
		/// </summary>
		public static View_LocTorture One(System.Linq.Expressions.Expression<Func<View_LocTorture, bool>> exp= null, string sortField = null, bool isDesc = true)
		{
    ...
    /// </summary>
    public partial class View_LocTortureVM : View_LocTorture, INotifyPropertyChanged {
		...
		public override int? LocTortureID {
			get => base.LocTortureID;
			set {
				if (System.Collections.Generic.EqualityComparer<int?>.Default.Equals(base.LocTortureID, value)) return;
				base.LocTortureID = value;
				OnPropertyChanged();
			}
		}

		public override string LocTortureName {
			get => base.LocTortureName;
			set {
				if (System.Collections.Generic.EqualityComparer<string>.Default.Equals(base.LocTortureName, value)) return;
				base.LocTortureName = value;
				OnPropertyChanged();
			}
		}
