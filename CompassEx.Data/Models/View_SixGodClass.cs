...
namespace CompassEx.Data.Models {
	...
	public partial class View_SixGodClass {
		...
		[JsonProperty]
		public virtual  int? SixGodClassID { get; set; }
	...
	/// <summary>
	/// 一键转换为支持 WPF 双向绑定的 View_SixGodClassVM 对象
	/// </summary>
	public virtual View_SixGodClassVM ToViewModel() {
		return new View_SixGodClassVM {
		...
		private static IFreeSql SafeOrm => Orm ?? throw new Exception($"{nameof(View_SixGodClass)}.Orm 未在程序启动时初始化。");
		...
		/// </summary>
		public static ISelect<View_SixGodClass> Select => SafeOrm.Select<View_SixGodClass>();
		
		/// <summary>
		/// 🎯 PageList 静态方法：纯粹获取分好页的数据集合（不含任何 out 属性），pageIndex 小于等于 0 时自动查全部
		/// </summary>
		public static List<View_SixGodClass> List(System.Linq.Expressions.Expression<Func<View_SixGodClass, bool>> exp = null, int pageIndex = 0, int pageSize = 10, string sortField = null, bool isDesc = true)
		{
			var query = Select;
		...
		/// </summary>
		public static long GetRecordCount(System.Linq.Expressions.Expression<Func<View_SixGodClass, bool>> exp = null)
		{
			var query = Select;
			if (exp != null) query = query.Where(exp);
		...
		/// </summary>
		public static View_SixGodClass One(System.Linq.Expressions.Expression<Func<View_SixGodClass, bool>> exp= null, string sortField = null, bool isDesc = true)
		{
    ...
    /// </summary>
    public partial class View_SixGodClassVM : View_SixGodClass, INotifyPropertyChanged {
		...
		public override int? SixGodClassID {
			get => base.SixGodClassID;
			set {
				if (System.Collections.Generic.EqualityComparer<int?>.Default.Equals(base.SixGodClassID, value)) return;
