...
namespace CompassEx.Data.Models {
	...
	public partial class View_LocCombine {
		...
		[JsonProperty]
		public virtual  int? LocCombineID { get; set; }

		[JsonProperty, Column(DbType = "VARCHAR(500)")]
		public virtual  string LocCombineName { get; set; }
	...
	/// <summary>
	/// 一键转换为支持 WPF 双向绑定的 View_LocCombineVM 对象
	/// </summary>
	public virtual View_LocCombineVM ToViewModel() {
		return new View_LocCombineVM {
			...
			LocCombineID = this.LocCombineID,
			LocCombineName = this.LocCombineName,
			Info = this.Info,
		};
	}
		...
		private static IFreeSql SafeOrm => Orm ?? throw new Exception($"{nameof(View_LocCombine)}.Orm 未在程序启动时初始化。");
		...
		/// </summary>
		public static ISelect<View_LocCombine> Select => SafeOrm.Select<View_LocCombine>();
		
		/// <summary>
		/// 🎯 PageList 静态方法：纯粹获取分好页的数据集合（不含任何 out 属性），pageIndex 小于等于 0 时自动查全部
		/// </summary>
		public static List<View_LocCombine> List(System.Linq.Expressions.Expression<Func<View_LocCombine, bool>> exp = null, int pageIndex = 0, int pageSize = 10, string sortField = null, bool isDesc = true)
		{
			var query = Select;
		...
		/// </summary>
		public static long GetRecordCount(System.Linq.Expressions.Expression<Func<View_LocCombine, bool>> exp = null)
		{
			var query = Select;
			if (exp != null) query = query.Where(exp);
		...
		/// </summary>
		public static View_LocCombine One(System.Linq.Expressions.Expression<Func<View_LocCombine, bool>> exp= null, string sortField = null, bool isDesc = true)
		{
    ...
    /// </summary>
    public partial class View_LocCombineVM : View_LocCombine, INotifyPropertyChanged {
		...
		public override int? LocCombineID {
			get => base.LocCombineID;
			set {
				if (System.Collections.Generic.EqualityComparer<int?>.Default.Equals(base.LocCombineID, value)) return;
				base.LocCombineID = value;
				OnPropertyChanged();
			}
		}

		public override string LocCombineName {
			get => base.LocCombineName;
			set {
				if (System.Collections.Generic.EqualityComparer<string>.Default.Equals(base.LocCombineName, value)) return;
				base.LocCombineName = value;
				OnPropertyChanged();
			}
		}
