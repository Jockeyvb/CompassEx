...
namespace CompassEx.Data.Models {
	...
	public partial class View_SkyCombine {
		...
		[JsonProperty]
		public virtual  int? SkyCombineID { get; set; }

		[JsonProperty, Column(DbType = "VARCHAR(500)")]
		public virtual  string SkyCombineName { get; set; }
	...
	/// <summary>
	/// 一键转换为支持 WPF 双向绑定的 View_SkyCombineVM 对象
	/// </summary>
	public virtual View_SkyCombineVM ToViewModel() {
		return new View_SkyCombineVM {
			...
			SkyCombineID = this.SkyCombineID,
			SkyCombineName = this.SkyCombineName,
			Info = this.Info,
		};
	}
		...
		/// </summary>
		public static ISelect<View_SkyCombine> Select => SafeOrm.Select<View_SkyCombine>();
		
		/// <summary>
		/// 🎯 PageList 静态方法：纯粹获取分好页的数据集合（不含任何 out 属性），pageIndex 小于等于 0 时自动查全部
		/// </summary>
		public static List<View_SkyCombine> List(System.Linq.Expressions.Expression<Func<View_SkyCombine, bool>> exp = null, int pageIndex = 0, int pageSize = 10, string sortField = null, bool isDesc = true)
		{
			var query = Select;
		...
		/// </summary>
		public static long GetRecordCount(System.Linq.Expressions.Expression<Func<View_SkyCombine, bool>> exp = null)
		{
			var query = Select;
			if (exp != null) query = query.Where(exp);
		...
		/// </summary>
		public static View_SkyCombine One(System.Linq.Expressions.Expression<Func<View_SkyCombine, bool>> exp= null, string sortField = null, bool isDesc = true)
		{
    ...
    /// </summary>
    public partial class View_SkyCombineVM : View_SkyCombine, INotifyPropertyChanged {
		...
		public override int? SkyCombineID {
			get => base.SkyCombineID;
			set {
				if (System.Collections.Generic.EqualityComparer<int?>.Default.Equals(base.SkyCombineID, value)) return;
				base.SkyCombineID = value;
				OnPropertyChanged();
			}
		}

		public override string SkyCombineName {
			get => base.SkyCombineName;
			set {
				if (System.Collections.Generic.EqualityComparer<string>.Default.Equals(base.SkyCombineName, value)) return;
				base.SkyCombineName = value;
				OnPropertyChanged();
			}
		}
