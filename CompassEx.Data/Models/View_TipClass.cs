...
namespace CompassEx.Data.Models {
	...
	public partial class View_TipClass {
		...
		[JsonProperty, Column(DbType = "VARCHAR(500)")]
		public virtual  string TipClassName { get; set; }

		[JsonProperty]
		public virtual  int? TipClassID { get; set; }
		...
		[JsonProperty]
		public virtual  int? IsComm { get; set; }


	/// <summary>
	/// 一键转换为支持 WPF 双向绑定的 View_TipClassVM 对象
	/// </summary>
	public virtual View_TipClassVM ToViewModel() {
		return new View_TipClassVM {
			ClassID = this.ClassID,
			PersonID = this.PersonID,
			Info = this.Info,
			TipClassName = this.TipClassName,
			TipClassID = this.TipClassID,
		...
		private static IFreeSql SafeOrm => Orm ?? throw new Exception($"{nameof(View_TipClass)}.Orm 未在程序启动时初始化。");
		...
		/// </summary>
		public static ISelect<View_TipClass> Select => SafeOrm.Select<View_TipClass>();
		
		/// <summary>
		/// 🎯 PageList 静态方法：纯粹获取分好页的数据集合（不含任何 out 属性），pageIndex 小于等于 0 时自动查全部
		/// </summary>
		public static List<View_TipClass> List(System.Linq.Expressions.Expression<Func<View_TipClass, bool>> exp = null, int pageIndex = 0, int pageSize = 10, string sortField = null, bool isDesc = true)
		{
			var query = Select;
		...
		/// </summary>
		public static long GetRecordCount(System.Linq.Expressions.Expression<Func<View_TipClass, bool>> exp = null)
		{
			var query = Select;
			if (exp != null) query = query.Where(exp);
		...
		/// </summary>
		public static View_TipClass One(System.Linq.Expressions.Expression<Func<View_TipClass, bool>> exp= null, string sortField = null, bool isDesc = true)
		{
    ...
    /// </summary>
    public partial class View_TipClassVM : View_TipClass, INotifyPropertyChanged {
		...
		public override string TipClassName {
			get => base.TipClassName;
			set {
				if (System.Collections.Generic.EqualityComparer<string>.Default.Equals(base.TipClassName, value)) return;
				base.TipClassName = value;
				OnPropertyChanged();
			}
		}

		public override int? TipClassID {
			get => base.TipClassID;
			set {
				if (System.Collections.Generic.EqualityComparer<int?>.Default.Equals(base.TipClassID, value)) return;
				base.TipClassID = value;
				OnPropertyChanged();
			}
		}
		...
		public override int? IsComm {
			get => base.IsComm;
			set {
				if (System.Collections.Generic.EqualityComparer<int?>.Default.Equals(base.IsComm, value)) return;
				base.IsComm = value;
				OnPropertyChanged();
			}
		}
