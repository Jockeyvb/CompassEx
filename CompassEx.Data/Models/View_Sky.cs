...
namespace CompassEx.Data.Models {
	...
	public partial class View_Sky {
		...
		[JsonProperty]
		public virtual  int? SkyID { get; set; }

		[JsonProperty, Column(DbType = "VARCHAR(500)")]
		public virtual  string SkyName { get; set; }


	/// <summary>
	/// 一键转换为支持 WPF 双向绑定的 View_SkyVM 对象
	/// </summary>
	public virtual View_SkyVM ToViewModel() {
		return new View_SkyVM {
		...
		private static IFreeSql SafeOrm => Orm ?? throw new Exception($"{nameof(View_Sky)}.Orm 未在程序启动时初始化。");
		...
		/// </summary>
		public static ISelect<View_Sky> Select => SafeOrm.Select<View_Sky>();
		
		/// <summary>
		/// 🎯 PageList 静态方法：纯粹获取分好页的数据集合（不含任何 out 属性），pageIndex 小于等于 0 时自动查全部
		/// </summary>
		public static List<View_Sky> List(System.Linq.Expressions.Expression<Func<View_Sky, bool>> exp = null, int pageIndex = 0, int pageSize = 10, string sortField = null, bool isDesc = true)
		{
			var query = Select;
		...
		/// </summary>
		public static long GetRecordCount(System.Linq.Expressions.Expression<Func<View_Sky, bool>> exp = null)
		{
			var query = Select;
			if (exp != null) query = query.Where(exp);
		...
		/// </summary>
		public static View_Sky One(System.Linq.Expressions.Expression<Func<View_Sky, bool>> exp= null, string sortField = null, bool isDesc = true)
		{
    ...
    /// </summary>
    public partial class View_SkyVM : View_Sky, INotifyPropertyChanged {
		...
		public override int? SkyID {
			get => base.SkyID;
			set {
				if (System.Collections.Generic.EqualityComparer<int?>.Default.Equals(base.SkyID, value)) return;
				base.SkyID = value;
				OnPropertyChanged();
			}
		}

		public override string SkyName {
			get => base.SkyName;
			set {
				if (System.Collections.Generic.EqualityComparer<string>.Default.Equals(base.SkyName, value)) return;
				base.SkyName = value;
				OnPropertyChanged();
			}
		}
