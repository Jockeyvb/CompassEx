...
namespace CompassEx.Data.Models {
	...
	public partial class View_LocConflict {
		...
		[JsonProperty]
		public virtual  int? LocConflictID { get; set; }

		[JsonProperty, Column(DbType = "VARCHAR(500)")]
		public virtual  string LocConflictName { get; set; }
	...
	/// <summary>
	/// 一键转换为支持 WPF 双向绑定的 View_LocConflictVM 对象
	/// </summary>
	public virtual View_LocConflictVM ToViewModel() {
		return new View_LocConflictVM {
			...
			LocConflictID = this.LocConflictID,
			LocConflictName = this.LocConflictName,
			Info = this.Info,
		};
	}
		...
		private static IFreeSql SafeOrm => Orm ?? throw new Exception($"{nameof(View_LocConflict)}.Orm 未在程序启动时初始化。");
		...
		/// </summary>
		public static ISelect<View_LocConflict> Select => SafeOrm.Select<View_LocConflict>();
		
		/// <summary>
		/// 🎯 PageList 静态方法：纯粹获取分好页的数据集合（不含任何 out 属性），pageIndex 小于等于 0 时自动查全部
		/// </summary>
		public static List<View_LocConflict> List(System.Linq.Expressions.Expression<Func<View_LocConflict, bool>> exp = null, int pageIndex = 0, int pageSize = 10, string sortField = null, bool isDesc = true)
		{
			var query = Select;
		...
		/// </summary>
		public static long GetRecordCount(System.Linq.Expressions.Expression<Func<View_LocConflict, bool>> exp = null)
		{
			var query = Select;
			if (exp != null) query = query.Where(exp);
		...
		/// </summary>
		public static View_LocConflict One(System.Linq.Expressions.Expression<Func<View_LocConflict, bool>> exp= null, string sortField = null, bool isDesc = true)
		{
    ...
    /// </summary>
    public partial class View_LocConflictVM : View_LocConflict, INotifyPropertyChanged {
		...
		public override int? LocConflictID {
			get => base.LocConflictID;
			set {
				if (System.Collections.Generic.EqualityComparer<int?>.Default.Equals(base.LocConflictID, value)) return;
				base.LocConflictID = value;
				OnPropertyChanged();
			}
		}

		public override string LocConflictName {
			get => base.LocConflictName;
			set {
				if (System.Collections.Generic.EqualityComparer<string>.Default.Equals(base.LocConflictName, value)) return;
				base.LocConflictName = value;
				OnPropertyChanged();
			}
		}
