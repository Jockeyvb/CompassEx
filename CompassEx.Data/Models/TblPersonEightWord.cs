...
namespace CompassEx.Data.Models
{
    ...
    public partial class TblPersonEightWord
    {
       ...
       #region 💡 萬能自動 OOP 資料庫操作方法 (Active Record)
        ...
        public static ReturnResultType Addnew(TblPersonEightWord entity)
        {
        ...
        public static ReturnResultType<TblPersonEightWord> GetTblPersonEightWord(string where = "", List<(string name,object value)> nameValue = null, string orderBy = "")
        {
            var rrt = new ReturnResultType<TblPersonEightWord>();
            try
            {
                var colResult = GetTblPersonEightWordCol(where, nameValue, orderBy, 1, 1);
        ...
        public static ReturnResultType<List<TblPersonEightWord>> GetTblPersonEightWordCol(string where = "", List<(string name,object value)> nameValue = null, string orderBy = "" , int pageIndex = 0, int pageSize = 10)
        {
            var rrt = new ReturnResultType<List<TblPersonEightWord>>();
            ...
            try
            {
                ...
                using (IDbConnection db = Comm.GetOpenConnection())
                {
                    var list = db.Query<TblPersonEightWord>(sqlBuilder.ToString(), dp).ToList();
                    rrt.ReturnObj = list;
                    rrt.RESULT = 1;
        ...
        public ViewModel GetVM()
        {
            ...
            vm.PersonEightWordId = this.PersonEightWordId;
        ...
        public class ViewModel : INotifyPropertyChanged
        {
            ...
            private string _personEightWordId;
            public string PersonEightWordId
            {
                get => _personEightWordId;
                set
                {
                    if (!EqualityComparer<string>.Default.Equals(_personEightWordId, value))
                    {
                        _personEightWordId = value;
                        OnPropertyChanged();
                    }
                }
            }
            ...
            public string? OldDate
            {
                ...
                set
                {
                    if (!EqualityComparer<string?>.Default.Equals(_oldDate, value))
                    {
                        _oldDate = value;
                        OnPropertyChanged();
                    }
            ...
            public TblPersonEightWord ToModel()
            {
                return new TblPersonEightWord
                {
