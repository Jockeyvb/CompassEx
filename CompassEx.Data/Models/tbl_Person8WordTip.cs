...
namespace CompassEx.Data.Models {
	...
	public partial class tbl_Person8WordTip {
		...
		[JsonProperty]
		public virtual  int IsTiped { get; set; } = 0;
	...
	/// <summary>
	/// 一键转换为支持 WPF 双向绑定的 tbl_Person8WordTipVM 对象
	/// </summary>
	public virtual tbl_Person8WordTipVM ToViewModel() {
		return new tbl_Person8WordTipVM {
		...
		private static IFreeSql SafeOrm => Orm ?? throw new Exception($"{nameof(tbl_Person8WordTip)}.Orm 未在程序启动时初始化。");
		...
		public void Refresh()
		{
			var dbEntity = One(t => t.Person8WordTipID == this.Person8WordTipID);
			if (dbEntity != null)
			{
				foreach (var prop in typeof(tbl_Person8WordTip).GetProperties(BindingFlags.Public | BindingFlags.Instance))
				{
					if (prop.CanWrite)
					{
		...
		/// </summary>
		public static ISelect<tbl_Person8WordTip> Select => SafeOrm.Select<tbl_Person8WordTip>();
		
		/// <summary>
		/// 🎯 PageList 静态方法：纯粹获取分好页的数据集合（不含任何 out 属性），pageIndex 小于等于 0 时自动查全部
		/// </summary>
		public static List<tbl_Person8WordTip> List(System.Linq.Expressions.Expression<Func<tbl_Person8WordTip, bool>> exp = null, int pageIndex = 0, int pageSize = 10, string sortField = null, bool isDesc = true)
		{
			var query = Select;
		...
		/// </summary>
		public static long GetRecordCount(System.Linq.Expressions.Expression<Func<tbl_Person8WordTip, bool>> exp = null)
		{
			var query = Select;
			if (exp != null) query = query.Where(exp);
		...
		/// </summary>
		public static tbl_Person8WordTip One(System.Linq.Expressions.Expression<Func<tbl_Person8WordTip, bool>> exp= null, string sortField = null, bool isDesc = true)
		{
    ...
    /// </summary>
    public partial class tbl_Person8WordTipVM : tbl_Person8WordTip, INotifyPropertyChanged {
