...
namespace CompassEx.Data.Models {
	...
	public partial class sqlite_stat1 {
	...
	/// <summary>
	/// 一键转换为支持 WPF 双向绑定的 sqlite_stat1VM 对象
	/// </summary>
	public virtual sqlite_stat1VM Tosqlite_stat1VM() {
		return new sqlite_stat1VM {
			tbl = this.tbl,
			idx = this.idx,
			stat = this.stat,
		};
		...
		private static IFreeSql SafeOrm => Orm ?? throw new Exception($"{nameof(sqlite_stat1)}.Orm 未在程序启动时初始化。");
		...
		/// <summary>
		    ...
		    /// </summary>
		    public bool Update() => SafeOrm.Update<sqlite_stat1>().SetSource(this).ExecuteAffrows() > 0;
		    /// <summary>
		    /// 🎯 实例销毁：从数据库中将当前对象自己删除
		    /// </summary>
		    public bool Delete() => SafeOrm.Delete<sqlite_stat1>().WhereDynamic(this).ExecuteAffrows() > 0;
		// ==========================================
		...
		/// </summary>
		public static bool AddNew(sqlite_stat1 entity)
		{
			if (entity == null) throw new ArgumentNullException(nameof(entity));
			
			if (typeof(String) == typeof(Guid))
			{
				var pkProp = typeof(sqlite_stat1).GetProperty("tbl");
		...
		/// </summary>
		public static bool Delete(String id) => SafeOrm.Delete<sqlite_stat1>().WhereDynamic(id).ExecuteAffrows() > 0;
		
		/// <summary>
		/// 🎯 静态按条件批量删除：支持复杂的 Lambda 表达式过滤删除
		/// </summary>
		public static bool Delete(System.Linq.Expressions.Expression<Func<sqlite_stat1, bool>> exp) => SafeOrm.Delete<sqlite_stat1>().Where(exp).ExecuteAffrows() > 0;
		...
		/// </summary>
		public static ISelect<sqlite_stat1> Select => SafeOrm.Select<sqlite_stat1>();
		
		/// <summary>
		/// 🎯 PageList 静态方法：纯粹获取分好页的数据集合（不含任何 out 属性），pageIndex 小于等于 0 时自动查全部
		/// </summary>
		public static List<sqlite_stat1> List(System.Linq.Expressions.Expression<Func<sqlite_stat1, bool>> exp = null, int pageIndex = 0, int pageSize = 10, string sortField = null, bool isDesc = true)
		{
			var query = Select;
		...
		/// </summary>
		public static long GetRecordCount(System.Linq.Expressions.Expression<Func<sqlite_stat1, bool>> exp = null)
		{
			var query = Select;
			if (exp != null) query = query.Where(exp);
		...
		/// </summary>
		public static sqlite_stat1 One(System.Linq.Expressions.Expression<Func<sqlite_stat1, bool>> exp= null, string sortField = null, bool isDesc = true)
		{
    ...
    /// </summary>
    public partial class sqlite_stat1VM : sqlite_stat1, INotifyPropertyChanged {
		...
		public override string stat {
			get => base.stat;
			set {
				if (System.Collections.Generic.EqualityComparer<string>.Default.Equals(base.stat, value)) return;
				base.stat = value;
				OnPropertyChanged();
			}
		}
