...
namespace CompassEx.Data.Models {
	...
	public partial class tbl_Person8WordList {

		[JsonProperty, Column(IsIdentity = true, StringLength = -2, IsPrimary = true, IsNullable = false)]
		public virtual  string Person8WordListID { get; set; }

		[JsonProperty]
		public virtual  int Person8WordID { get; set; } = 0;
		...
		[JsonProperty, Column(StringLength = -2)]
		public virtual  string Person8WordWebID { get; set; }
	...
	/// <summary>
	/// 一键转换为支持 WPF 双向绑定的 tbl_Person8WordListVM 对象
	/// </summary>
	public virtual tbl_Person8WordListVM ToViewModel() {
		return new tbl_Person8WordListVM {
		...
		private static IFreeSql SafeOrm => Orm ?? throw new Exception($"{nameof(tbl_Person8WordList)}.Orm 未在程序启动时初始化。");
		...
		public void Refresh()
		{
			var dbEntity = One(t => t.Person8WordListID == this.Person8WordListID);
			if (dbEntity != null)
			{
				foreach (var prop in typeof(tbl_Person8WordList).GetProperties(BindingFlags.Public | BindingFlags.Instance))
				{
					if (prop.CanWrite)
					{
		...
		/// </summary>
		public static ISelect<tbl_Person8WordList> Select => SafeOrm.Select<tbl_Person8WordList>();
		
		/// <summary>
		/// 🎯 PageList 静态方法：纯粹获取分好页的数据集合（不含任何 out 属性），pageIndex 小于等于 0 时自动查全部
		/// </summary>
		public static List<tbl_Person8WordList> List(System.Linq.Expressions.Expression<Func<tbl_Person8WordList, bool>> exp = null, int pageIndex = 0, int pageSize = 10, string sortField = "CreateTime", bool isDesc = true)
		{
			var query = Select;
		...
		/// </summary>
		public static long GetRecordCount(System.Linq.Expressions.Expression<Func<tbl_Person8WordList, bool>> exp = null)
		{
			var query = Select;
			if (exp != null) query = query.Where(exp);
		...
		/// </summary>
		public static tbl_Person8WordList One(System.Linq.Expressions.Expression<Func<tbl_Person8WordList, bool>> exp= null, string sortField = "CreateTime", bool isDesc = true)
		{
    ...
    /// </summary>
    public partial class tbl_Person8WordListVM : tbl_Person8WordList, INotifyPropertyChanged {

		public override string Person8WordListID {
			get => base.Person8WordListID;
			set {
				if (System.Collections.Generic.EqualityComparer<string>.Default.Equals(base.Person8WordListID, value)) return;
				base.Person8WordListID = value;
				OnPropertyChanged();
			}
		}

		public override int Person8WordID {
			get => base.Person8WordID;
			set {
				if (System.Collections.Generic.EqualityComparer<int>.Default.Equals(base.Person8WordID, value)) return;
				base.Person8WordID = value;
				OnPropertyChanged();
			}
		}
		...
		public override string Person8WordWebID {
			get => base.Person8WordWebID;
			set {
				if (System.Collections.Generic.EqualityComparer<string>.Default.Equals(base.Person8WordWebID, value)) return;
				base.Person8WordWebID = value;
				OnPropertyChanged();
			}
		}
