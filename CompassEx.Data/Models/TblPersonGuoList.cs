...
namespace CompassEx.Data.Models
{
    ...
    [Dapper.Contrib.Extensions.Table("tbl_PersonGuoList")]
    public partial class TblPersonGuoList
    {
        [Dapper.Contrib.Extensions.Key]
        public string PersonGuoListId { get; set; }
        ...
        public string PersonGuoWebId { get; set; }
        public string WebId { get; set; }

       #region 💡 萬能自動 OOP 資料庫操作方法 (Active Record)

        public static ReturnResultType Addnew(TblPersonGuoList entity)
        {
        ...
        public static ReturnResultType<TblPersonGuoList> GetTblPersonGuoList(string where = "", List<(string name,object value)> nameValue = null, string orderBy = "")
        {
            var rrt = new ReturnResultType<TblPersonGuoList>();
            try
            {
                var colResult = GetTblPersonGuoListCol(where, nameValue, orderBy, 1, 1);
        ...
        public static ReturnResultType<List<TblPersonGuoList>> GetTblPersonGuoListCol(string where = "", List<(string name,object value)> nameValue = null, string orderBy = "" , int pageIndex = 0, int pageSize = 10)
        {
            var rrt = new ReturnResultType<List<TblPersonGuoList>>();
            
            try
            {
                var sqlBuilder = new System.Text.StringBuilder();
                sqlBuilder.Append("SELECT * FROM [tbl_PersonGuoList] WHERE 1=1");
                ...
                using (IDbConnection db = Comm.GetOpenConnection())
                {
                    var list = db.Query<TblPersonGuoList>(sqlBuilder.ToString(), dp).ToList();
                    rrt.ReturnObj = list;
                    rrt.RESULT = 1;
        ...
        public ViewModel GetVM()
        {
            ...
            vm.PersonGuoListId = this.PersonGuoListId;
            ...
            vm.PersonGuoWebId = this.PersonGuoWebId;
            vm.WebId = this.WebId;
            return vm;
        }
        ...
        public class ViewModel : INotifyPropertyChanged
        {
            ...
            private string _personGuoListId;
            public string PersonGuoListId
            {
                get => _personGuoListId;
                set
                {
                    if (!EqualityComparer<string>.Default.Equals(_personGuoListId, value))
                    {
                        _personGuoListId = value;
                        OnPropertyChanged();
                    }
                }
            }
            ...
            private string _personGuoWebId;
            public string PersonGuoWebId
            {
                get => _personGuoWebId;
                set
                {
                    if (!EqualityComparer<string>.Default.Equals(_personGuoWebId, value))
                    {
                        _personGuoWebId = value;
                        OnPropertyChanged();
                    }
                }
            }
            ...
            public string WebId
            {
                ...
                set
                {
                    if (!EqualityComparer<string>.Default.Equals(_webId, value))
                    {
                        _webId = value;
                        OnPropertyChanged();
                    }
            ...
            public TblPersonGuoList ToModel()
            {
                return new TblPersonGuoList
                {
