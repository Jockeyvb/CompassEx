...
namespace CompassEx.Data.Models {
	...
	public partial class View_PersonEightWord {

		[JsonProperty, Column(StringLength = -2)]
		public virtual  string PersonEightWordID { get; set; }

		[JsonProperty, Column(DbType = "")]
		public virtual  string IsHadTip { get; set; }
		...
		[JsonProperty, Column(DbType = "")]
		public virtual  string IsTiped { get; set; }
	...
	/// <summary>
	/// 一键转换为支持 WPF 双向绑定的 View_PersonEightWordVM 对象
	/// </summary>
	public virtual View_PersonEightWordVM ToViewModel() {
		return new View_PersonEightWordVM {
			PersonEightWordID = this.PersonEightWordID,
			IsHadTip = this.IsHadTip,
		...
		private static IFreeSql SafeOrm => Orm ?? throw new Exception($"{nameof(View_PersonEightWord)}.Orm 未在程序启动时初始化。");
		...
		/// </summary>
		public static ISelect<View_PersonEightWord> Select => SafeOrm.Select<View_PersonEightWord>();
		
		/// <summary>
		/// 🎯 PageList 静态方法：纯粹获取分好页的数据集合（不含任何 out 属性），pageIndex 小于等于 0 时自动查全部
		/// </summary>
		public static List<View_PersonEightWord> List(System.Linq.Expressions.Expression<Func<View_PersonEightWord, bool>> exp = null, int pageIndex = 0, int pageSize = 10, string sortField = "CreateTime", bool isDesc = true)
		{
			var query = Select;
		...
		/// </summary>
		public static long GetRecordCount(System.Linq.Expressions.Expression<Func<View_PersonEightWord, bool>> exp = null)
		{
			var query = Select;
			if (exp != null) query = query.Where(exp);
		...
		/// </summary>
		public static View_PersonEightWord One(System.Linq.Expressions.Expression<Func<View_PersonEightWord, bool>> exp= null, string sortField = "CreateTime", bool isDesc = true)
		{
    ...
    /// </summary>
    public partial class View_PersonEightWordVM : View_PersonEightWord, INotifyPropertyChanged {
		...
		public override string IsHadTip {
			get => base.IsHadTip;
			set {
				if (System.Collections.Generic.EqualityComparer<string>.Default.Equals(base.IsHadTip, value)) return;
				base.IsHadTip = value;
				OnPropertyChanged();
			}
		}
		...
		public override string IsTiped {
			get => base.IsTiped;
			set {
				if (System.Collections.Generic.EqualityComparer<string>.Default.Equals(base.IsTiped, value)) return;
				base.IsTiped = value;
				OnPropertyChanged();
			}
		}
